---
title: "Data Preprocessing and Analysis for MRes Project"
...
cholesterol_tbl <- cholesterol_tbl %>% group_by(f.eid) %>%
  summarise(date_lipidaemia = min(date_lipidaemia),
            date_lipidaemia = min(date_lipidaemia),
            date_lipidaemia = min(date_lipidaemia),
...
print("--------")
cat("No of Stroke patients in whole sample:", sum(sample_df$Stroke_Status), "\n")
cat("No of IHD patients in whole sample:", sum(sample_df$IHD_status), "\n")
cat("No of non IHD patients in whole sample:", sum(sample_df$non_IHD_status), "\n")
cat("No of HF patients in whole sample:", sum(sample_df$HF_status), "\n")
cat("No of HA patients in whole sample:", sum(sample_df$HA_status), "\n")
