...
test_df <- df_cmr_baseline %>% dplyr::filter(f.eid %in% cmr_bc_ids) %>% filter(sex == 0) # CMR and BC (women only)
test_df <- df_cmr_baseline %>% dplyr::filter(f.eid %in% cmr_no_bc_ids) %>% filter(sex == 0)
nrow(test_df)
...
# write.table(sum_table, 'summary_stats_CMR-BC_women_only.tsv', sep = "\t")
# write.table(sum_table, 'summary_stats_CMR-no-BC_women_only.tsv', sep = "\t")
...
```{r}
cmr_df <- inner_join(cmr_measures_tbl, cmr_original_df, by = "f.eid")
cmr_df <- inner_join(cmr_df, cmr_t1_df %>% select(f.eid, t1), by = "f.eid")
cmr_df <- inner_join(cmr_df, GLM_df, by = "f.eid")
cmr_df <- inner_join(cmr_df, bsa_tbl, by = "f.eid")
...
test_df <- cmr_df %>% dplyr::filter(f.eid %in% cmr_bc_ids) %>% filter(sex == 0)
...
test_df <- GLM_df %>% 
  select(f.eid, BC_status, BC_diagnosis_date, prev_status_NICM, incident_status_NICM, 
         age_at_recruitment, recruitment_date, time,
         smoking_status_at_recruitment, ethnicity_at_recruitment,
         deprivation_index, alc_intake_at_recruitment, mets_imaging_visit1,
...
write.table(filtered_cox_combined_info, file = "cmr-abstract_cox_regressions_table.tsv", sep = "\t", row.names = F)
```
...
### max_LV_WT Model
formula = max_LV_WT ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVMi Model
formula = LV_mass2 ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVEDVI MODEL 
formula = LVEDVI ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVM:LDEDV Model
formula = LVM_LDEDV ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVSVi Model
formula = LVSVi ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVEF Model
formula = LVEF ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LVGFI Model
formula = LVGFI ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### GLS Model
formula = GLS ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### max_LAVi Model
formula = max_LAVi ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### LAEF Model
formula = LAEF ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### RVEDVi Model
formula = RVEDVi ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### RVSVi Model
formula = RVSVi ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### RVEF Model
formula = RVEF ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
### DAo Model
formula = DAo ~ BC_status + age_at_recruitment + 
  smoking_status_at_recruitment + alc_intake_at_recruitment + 
  mets_imaging_visit1 + 
  deprivation_index +
  prev_status_diabetes + prev_status_cholesterol + prev_status_hypertension
...
```
```{r}
write.table(filtered_combined_info, file = "results_lin_regre_all_CMR_measures.tsv", sep = "\t", row.names = F)
```
