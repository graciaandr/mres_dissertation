...
res.cox  <- coxph(formula, data = test_df)
cox_models <- c(cox_models, res.cox)
...
# Apply tidy() to each model and store the results in a list
tidy_results <- map(cox_models, tidy)
# Combine the results into a single data frame
overview_table <- bind_rows(tidy_results, .id = "Model")
