...
test_df <- cmr_df %>% dplyr::filter(f.eid %in% cmr_ids)
...
table_for_summary_stats <- tableby(~LVEDVI + LV_mass2 + LVEF + LVGFI + GLS, data = test_df,
                      numeric.stats=c("median", "q1q3"), na.tableby(FALSE))
...
# write.table(sum_table, 'cmr_stats_CMR-whole_sample.tsv', sep = "\t")
# write.table(sum_table, 'cmr_stats_CMR-BC_patients.tsv', sep = "\t")
# write.table(sum_table, 'cmr_stats_CMR-no_BC_patients.tsv', sep = "\t")
# write.table(sum_table, 'cmr_stats_CMR-BC_but_no_MRT_patients.tsv', sep = "\t")
# write.table(sum_table, 'cmr_stats_CMR-BC_and_MRT_patients.tsv', sep = "\t")
```
